...
class MyFardels extends Component {
  ...
  newFardelContentsTextInputHandler(event) {
    ...
    if (((new TextEncoder().encode(event.target.value))).length <= 280) {
      ...
      setNewFardelContents({
        ...newFardelContents,
        contents: newFardelContents.contents,
      });
    }
  }
  ...
  newFardelIpfsInputHandler(event) {
    ...
    if (((new TextEncoder().encode(event.target.value))).length <= 128) {
      setNewFardelContents({
        ...newFardelContents,
        ipfs: event.target.value,
      });
    } else {
      setNewFardelContents({
        ...newFardelContents,
        ipfs: newFardelContents.ipfs,
      });
    }
  }
          ...
          <Grid item xs={8}>
            <Paper className={classes.paper} variant="outlined">
              ...
              <TextField
                ...
                label="Contents"
                value={newFardelContents.contents}
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(useStyles)(MyFardels));
